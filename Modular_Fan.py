...
# PATH = r"J:\Dropbox\Coding & Tools\3D Printer & Robotics\STL & G-Code Files\Current Prints\Voronoi Deer\Deer_Voronoi_remix\files";
...
FILE = "\\" + r"string_test_fast_pyramid_v1";
...
LAYER_BEGING = 5; # 10; # 5; # 2; # First layer on which the fan will be turned on. Must be grater or equal to 1
LEYER_STEP = 1; # 3; # 1; # Number of layers between a change in fan speed 
FAN_STEP = 6; # 4; # 6; # 8; # Incremental value of the fan's speed after each change
FAN_MIN_PERCENTAGE = 10; # 30; # Initial fan speed on layer numer LAYER_BEGING
FAN_MAX_PERCENTAGE = 100; # 80; # The max speed at which the fan can run
...
STATUS_ON_FILE = "Created by Modular_Fan.py script. Itamar Katz.\n";
